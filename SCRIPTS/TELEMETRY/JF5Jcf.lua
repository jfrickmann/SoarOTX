...
local files = {
	...
	"/SCRIPTS/TELEMETRY/JF5Jalign.lua",
	"/SCRIPTS/TELEMETRY/JF5Jbrkcrv.lua",
	"/SCRIPTS/TELEMETRY/JF5Jailcmb.lua",
	"/SCRIPTS/TELEMETRY/JF5Jadjmix.lua" }
